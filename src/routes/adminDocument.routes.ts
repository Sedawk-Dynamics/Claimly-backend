...
import { verifyDocumentController, rejectDocumentController, getKycDocumentsController, getReVerificationDocumentsController } from '../controllers/adminDocument.controller';
